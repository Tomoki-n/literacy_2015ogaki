...
class storyViewController:UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        case 0:
            gametext.text = "草原のボス＜黒猫ヤマト＞を倒した勇者は、さらなる強さを求めて海岸へ向かいました。勇者は最後に”双鯨デル＆トラ”と呼ばれる二頭のクジラと戦います。風を操る“デル”は背中から強力な突風を発生させ、勇者を吹き飛ばそうとします。敵と戦いながら海岸にあるいくつかの海にまつわるアイテムを集めてより強い装備を作り上げ、ボスに挑むのでした。"
            break
        case 1:
            gametext.text = "海岸のボス＜双鯨デル＆トラ＞を倒した勇者は、次の敵を倒すため森林へと向かいました。暗い森林にはどこに恐ろしい敵が潜んでいるかわかりません。森林には海岸よりたくさんのアイテムあります。アイテムを全て集め、より強い装備で敵に挑んでいくのでした。"
            break
        case 2:
            gametext.text = "森林のボス＜孤狼ウルヴァ＞を倒した勇者は、次の敵を倒すため砂漠へと向かいました。砂漠には好戦的な敵がたくさんいます。アイテムの一つ「星の砂」は過去にやってきた勇者が敵に体内の水分を奪い取られて残った残骸です。敵に水分を奪い取られ、「星の砂」になってしまわないように、アイテムを集めて敵を倒しにいくのでした。"
            break
        case 3:
